...
/**
 * implement a controller class which specifies the seeds of the crawl, the
 * folder in which intermediate crawl data should be stored and the number of
 * concurrent threads:
 */
public class Controller {
	public static void main(String[] args) throws Exception {
		...
		// To demonstrate an example of how you can pass objects to crawlers, we use an
		// AtomicInteger that crawlers
